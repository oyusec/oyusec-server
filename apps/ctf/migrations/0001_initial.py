    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('solution', models.CharField(default='', max_length=500, null=True, verbose_name='Solution')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateTimeField(auto_now_add=True, verbose_name='Created date')),
                ('last_updated_date', models.DateTimeField(auto_now=True, verbose_name='Last updated date')),
                ('reaction', models.CharField(choices=[('like', 'like'), ('dislike', 'dislike')], default='like', max_length=100, verbose_name='Reaction')),
